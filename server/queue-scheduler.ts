...
export class QueueScheduler {
  ...
  private timeoutRules: number[] = [10, 30, 60, 120, 240, 480, 720]; // minutes
   ...
   async setSocketManager(socketManager: CrmRealtimeManager): void {
   ...
   */
   async startChecking(intervalMs: number = 60000): void {
   ...
   */
   async setTimeoutRules(timeoutMinutes: number[]): void {
