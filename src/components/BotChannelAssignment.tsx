...
export function BotChannelAssignment({
  ...
  return (
    <div className="relative flex items-center gap-3">
      {/* Flow name display */}
      <div className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium bg-slate-100 border border-slate-200 rounded-lg">
        <span className="text-slate-600">Flujo:</span>
      ...
      {showPanel && createPortal(
        <>
          ...
          <div className="fixed right-4 top-20 w-80 bg-white border border-slate-200 rounded-lg shadow-2xl z-[9999] max-h-[80vh] overflow-y-auto">
