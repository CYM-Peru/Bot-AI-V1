    ...
    <div className="fixed bottom-4 right-4 z-50 w-[420px] h-[700px] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden animate-slide-up">
      ...
      <div className="flex-shrink-0 p-4 border-t border-slate-200 bg-white">
        <div className="relative">
          {/* Help Button */}
          <button
            className="absolute -top-2 -right-2 bg-gradient-to-br from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white text-xs font-bold px-2 py-6 rounded-l-lg shadow-lg transition-all z-10 writing-mode-vertical"
            title="Get help"
